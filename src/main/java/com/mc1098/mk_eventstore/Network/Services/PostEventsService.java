 ...
 */
public class PostEventsService implements EventStoreService
{
    ...
    public PostEventsService(String entityName, long entityId, long version, 
            Event[] events)
    {
    ...
    public ServiceResult execute(EventStore store)
    {
        try
        {
            store.save(entityName, entityId, version, events);
            return new ServiceResult(this, "Events saved.");
